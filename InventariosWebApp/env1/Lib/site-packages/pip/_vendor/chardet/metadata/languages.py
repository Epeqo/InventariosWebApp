...
LANGUAGES = {
    ...
    "Czech": Language(
        ...
        alphabet="áčďéěíňořšťúůýžÁČĎÉĚÍŇoŘŠŤÚŮÝŽ",
    ...
    "Hungarian": Language(
        ...
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet="abcdefghijklmnoprstuvzáéíoöőúüűABCDEFGHIJKLMNOPRSTUVZÁÉÍoÖŐÚÜŰ",
    ...
    "Polish": Language(
        ...
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet="AĄBCĆDEĘFGHIJKLŁMNŃOoPRSŚTUWYZŹŻaąbcćdeęfghijklłmnńooprsśtuwyzźż",
        wiki_start_pages=["Wikipedia:Strona_głowna"],
    ),
    "Portuguese": Language(
        name="Portuguese",
        iso_code="pt",
        use_ascii=True,
        charsets=["ISO-8859-1", "ISO-8859-15", "WINDOWS-1252", "MacRoman"],
        alphabet="ÁÂÃÀÇÉÊÍoÔÕÚáâãàçéêíoôõú",
    ...
    "Slovak": Language(
        ...
        use_ascii=True,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet="áäčďéíĺľňoôŕšťúýžÁÄČĎÉÍĹĽŇoÔŔŠŤÚÝŽ",
